    ...
    vector<Token> eval_rpn() {
        ...
        while (!eof()) {
            ...
            case TokenType::CloseBracket:
                while (op.top().token_type != TokenType::OpenBracket) {
                ...
                break;
            case TokenType::Operator:
                if (op.empty() || op.top().token_type == TokenType::OpenBracket) {
                    op.push(token);
                } else {
                    while (!op.empty() && op.top().token_type != TokenType::OpenBracket) {
